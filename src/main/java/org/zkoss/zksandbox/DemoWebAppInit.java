...
public class DemoWebAppInit implements WebAppInit {
	...
	@SuppressWarnings("serial") private static Map<String, Category> _cateMap = new LinkedHashMap<String, Category> () {
	...
	@SuppressWarnings("serial") private static Map<String, Category> _mobileCateMap = new LinkedHashMap<String, Category> () {
	...
	public static Map<String, Category> getCateMap() {
		return _cateMap;
	}
	
	public static Map<String, Category> getMobilCateMap() {
